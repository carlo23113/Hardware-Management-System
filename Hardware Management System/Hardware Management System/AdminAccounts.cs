...
namespace Hardware_Management_System
{
    public partial class AdminAccounts : UserControl
    {
        ...
        private void AdminAccounts_Load(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlDataAdapter sda = new SqlDataAdapter("select ID, concat(firstname,' ',middlename,' ',lastname) as fullname, age, birthdate, address, contactno, username, password from adminaccounts_tbl", con);
